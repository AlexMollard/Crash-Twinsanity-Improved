...
| ✅ | Rooftop Rampage, second copy | 6.6 s → 4.1 s | The scene also runs from `roofcor2` (the Nina route) and had no skip there at all. Found by `tools/skip_survey.py`; prompt verified on screen |
